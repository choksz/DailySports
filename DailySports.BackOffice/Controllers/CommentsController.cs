...
namespace DailySports.BackOffice.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description,UserId")] Comments comments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description,UserId")] Comments comments)
        {
            if (ModelState.IsValid)
            {
